...
const THEME_OPTIONS: ThemeOption[] = [
  { value: 'dark', label: 'Escuro', icon: 'dark_mode', description: 'Interface escura para ambientes com pouca luz' },
  { value: 'light', label: 'Claro', icon: 'light_mode', description: 'Interface clara para ambientes bem iluminados' },
  { value: 'system', label: 'Sistema', icon: 'settings_brightness', description: 'Segue a preferência do sistema operacional' },
];
          ...
          <button
            ...
            <div class="flex items-center gap-2 w-full">
              ...
              @if (isSelected(option.value)) {
                <mat-icon class="!text-[18px] !w-[18px] !h-[18px] text-cyan-400">check_circle</mat-icon>
              }
            </div>
