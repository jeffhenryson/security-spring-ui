...
export class LoginComponent {
  ...
  readonly showGoogleLogin = computed(() => this.appConfig.googleEnabled());
  readonly showForgotPassword = computed(() => this.appConfig.forgotPasswordEnabled());
  readonly showRegisterLink = computed(() => this.appConfig.registrationEnabled());
